...
// ============================================================
const DEFAULT_KEYS = [
  { name: 'A1',  note: 'A',      octave: 1, pca: 0, motor: 12  },
  { name: 'B1',  note: 'B',      octave: 1, pca: 0, motor: 13 },
  { name: 'C2',  note: 'C',      octave: 2, pca: 0, motor: 0 },
  { name: 'C#2', note: 'C#/Db',  octave: 2, pca: 0, motor: 10 },
  { name: 'D2',  note: 'D',      octave: 2, pca: 0, motor: 1 },
  { name: 'D#2', note: 'D#/Eb',  octave: 2, pca: 0, motor: 11 },
  { name: 'E2',  note: 'E',      octave: 2, pca: 0, motor: 2 },
  { name: 'F2',  note: 'F',      octave: 2, pca: 0, motor: 3 },
  { name: 'F#2', note: 'F#/Gb',  octave: 2, pca: 0, motor: 7 },
  { name: 'G2',  note: 'G',      octave: 2, pca: 0, motor: 4 },
  { name: 'G#2', note: 'G#/Ab',  octave: 2, pca: 0, motor: 8 },
  { name: 'A2',  note: 'A',      octave: 2, pca: 0, motor: 5 },
  { name: 'A#2', note: 'A#/Bb',  octave: 2, pca: 0, motor: 9 },
  { name: 'B2',  note: 'B',      octave: 2, pca: 0, motor: 6 },
  { name: 'C3',  note: 'C',      octave: 3, pca: 0, motor: 14 },
  { name: 'D3',  note: 'D',      octave: 3, pca: 0, motor: 15 },
];
