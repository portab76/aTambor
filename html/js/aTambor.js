...
// Cada canal = un servo. Cada fila = stepsPerMeasure pasos.
...
//        firmware routing: chip = motor/ stepsPerMeasure, canal = motor% stepsPerMeasure
//
...
const DEFAULT_KEYS = [
  ...
  // ── PCA 0  (I2C 0x40)  —  C1–B1  (motors 0-11, 12-15 libres) ─
  { name: 'C1',  note: 'C',      octave: 1, pca: 0, motor: 40  },
  { name: 'C#1', note: 'C#/Db',  octave: 1, pca: 0, motor: 41  },
  { name: 'D1',  note: 'D',      octave: 1, pca: 0, motor: 42  },
  { name: 'D#1', note: 'D#/Eb',  octave: 1, pca: 0, motor: 43  },
  { name: 'E1',  note: 'E',      octave: 1, pca: 0, motor: 44  },
  { name: 'F1',  note: 'F',      octave: 1, pca: 0, motor: 45  },
  { name: 'F#1', note: 'F#/Gb',  octave: 1, pca: 0, motor: 46  },
  { name: 'G1',  note: 'G',      octave: 1, pca: 0, motor: 47  },
  { name: 'G#1', note: 'G#/Ab',  octave: 1, pca: 0, motor: 48  },
  { name: 'A1',  note: 'A',      octave: 1, pca: 0, motor: 49  },
  { name: 'A#1', note: 'A#/Bb',  octave: 1, pca: 0, motor: 50 },
  { name: 'B1',  note: 'B',      octave: 1, pca: 0, motor: 51 },

  // ── PCA 1  (I2C 0x41)  —  C2–B2  (motors 16-27, 28-31 libres) ─
  { name: 'C2',  note: 'C',      octave: 2, pca: 1, motor: 16 },
  { name: 'C#2', note: 'C#/Db',  octave: 2, pca: 1, motor: 17 },
  { name: 'D2',  note: 'D',      octave: 2, pca: 1, motor: 18 },
  { name: 'D#2', note: 'D#/Eb',  octave: 2, pca: 1, motor: 19 },
  { name: 'E2',  note: 'E',      octave: 2, pca: 1, motor: 20 },
  { name: 'F2',  note: 'F',      octave: 2, pca: 1, motor: 21 },
  { name: 'F#2', note: 'F#/Gb',  octave: 2, pca: 1, motor: 22 },
  { name: 'G2',  note: 'G',      octave: 2, pca: 1, motor: 23 },
  { name: 'G#2', note: 'G#/Ab',  octave: 2, pca: 1, motor: 24 },
  { name: 'A2',  note: 'A',      octave: 2, pca: 1, motor: 25 },
  { name: 'A#2', note: 'A#/Bb',  octave: 2, pca: 1, motor: 26 },
  { name: 'B2',  note: 'B',      octave: 2, pca: 1, motor: 27 },

  // ── PCA 2  (I2C 0x42)  —  C3–B3  (motors 32-43, 44-47 libres) ─
  { name: 'C3',  note: 'C',      octave: 3, pca: 2, motor: 0 },
  { name: 'C#3', note: 'C#/Db',  octave: 3, pca: 2, motor: 1 },
  { name: 'D3',  note: 'D',      octave: 3, pca: 2, motor: 2 },
  { name: 'D#3', note: 'D#/Eb',  octave: 3, pca: 2, motor: 3 },
  { name: 'E3',  note: 'E',      octave: 3, pca: 2, motor: 4 },
  { name: 'F3',  note: 'F',      octave: 3, pca: 2, motor: 5 },
  { name: 'F#3', note: 'F#/Gb',  octave: 3, pca: 2, motor: 6 },
  { name: 'G3',  note: 'G',      octave: 3, pca: 2, motor: 7 },
  { name: 'G#3', note: 'G#/Ab',  octave: 3, pca: 2, motor: 8 },
  { name: 'A3',  note: 'A',      octave: 3, pca: 2, motor: 9 },
  { name: 'A#3', note: 'A#/Bb',  octave: 3, pca: 2, motor: 10 },
  { name: 'B3',  note: 'B',      octave: 3, pca: 2, motor: 11 },

  // ── PCA 3  (I2C 0x43)  —  C4–B4  (motors 48-59, 60-63 libres) ─
  { name: 'C4',  note: 'C',      octave: 4, pca: 3, motor: 48 },
  { name: 'C#4', note: 'C#/Db',  octave: 4, pca: 3, motor: 49 },
  { name: 'D4',  note: 'D',      octave: 4, pca: 3, motor: 50 },
  { name: 'D#4', note: 'D#/Eb',  octave: 4, pca: 3, motor: 51 },
  { name: 'E4',  note: 'E',      octave: 4, pca: 3, motor: 52 },
  { name: 'F4',  note: 'F',      octave: 4, pca: 3, motor: 53 },
  { name: 'F#4', note: 'F#/Gb',  octave: 4, pca: 3, motor: 54 },
  { name: 'G4',  note: 'G',      octave: 4, pca: 3, motor: 55 },
  { name: 'G#4', note: 'G#/Ab',  octave: 4, pca: 3, motor: 56 },
  { name: 'A4',  note: 'A',      octave: 4, pca: 3, motor: 57 },
  { name: 'A#4', note: 'A#/Bb',  octave: 4, pca: 3, motor: 58 },
  { name: 'B4',  note: 'B',      octave: 4, pca: 3, motor: 59 },

  // ── PCA 4  (I2C 0x44)  —  C5–B5  (motors 64-75, 76-79 libres) ─
  { name: 'C5',  note: 'C',      octave: 5, pca: 4, motor: 64 },
  { name: 'C#5', note: 'C#/Db',  octave: 5, pca: 4, motor: 65 },
  { name: 'D5',  note: 'D',      octave: 5, pca: 4, motor: 66 },
  { name: 'D#5', note: 'D#/Eb',  octave: 5, pca: 4, motor: 67 },
  { name: 'E5',  note: 'E',      octave: 5, pca: 4, motor: 68 },
  { name: 'F5',  note: 'F',      octave: 5, pca: 4, motor: 69 },
  { name: 'F#5', note: 'F#/Gb',  octave: 5, pca: 4, motor: 70 },
  { name: 'G5',  note: 'G',      octave: 5, pca: 4, motor: 71 },
  { name: 'G#5', note: 'G#/Ab',  octave: 5, pca: 4, motor: 72 },
  { name: 'A5',  note: 'A',      octave: 5, pca: 4, motor: 73 },
  { name: 'A#5', note: 'A#/Bb',  octave: 5, pca: 4, motor: 74 },
  { name: 'B5',  note: 'B',      octave: 5, pca: 4, motor: 75 },
...
const TIME_SIGNATURES = {
  '2/4':  { stepsPerMeasure: 8,  label: '2/4'  },
  '3/4':  { stepsPerMeasure: 12, label: '3/4'  },
  '4/4':  { stepsPerMeasure: 16, label: '4/4'  },
  '6/8':  { stepsPerMeasure: 12, label: '6/8'  },
  '9/8':  { stepsPerMeasure: 18, label: '9/8'  },
  '12/8': { stepsPerMeasure: 24, label: '12/8' },
};
let currentTimeSig   = '4/4';
let stepsPerMeasure  = 16;

let numMeasures  = 1;
let numSteps     = stepsPerMeasure;  // numMeasures * stepsPerMeasure
...
let toneInitialized = false;   // Tone.Transport (metrónomo)
let midiJsReady     = false;   // MIDI.js soundfont cargado
let currentInstrument = 'acoustic_grand_piano';
let _activeMidiNotes  = new Set();  // notas activas para poder pararlas con STOP
...
function emptyChannel(index) {
  return { name: `Drum ${index + 1}`, motor: index, pca: Math.floor(index / 16), vel: 60, homePwm: 375, muted: false, sustain: false, steps: new Array(numSteps).fill(0), vels: new Array(numSteps).fill(0), notation: { dynamics: {}, articulations: {} } };
}
...
function setMeasures(n) {
  ...
  const newSteps = n * stepsPerMeasure;
  channels.forEach(ch => {
    if (!ch.vels) ch.vels = new Array(ch.steps.length).fill(0);
    if (newSteps === ch.steps.length) return;
    if (newSteps > ch.steps.length) {
      while (ch.steps.length < newSteps) { ch.steps.push(0); ch.vels.push(0); }
    } else {
      ch.steps = ch.steps.slice(0, newSteps);
      ch.vels  = ch.vels.slice(0, newSteps);
    }
  });
  numMeasures = n;
  numSteps    = newSteps;
...
// ── Inicializar MIDI.js con soundfont real ────────────────────
function initMidiAudio() {
  return new Promise((resolve) => {
    if (midiJsReady) { resolve(); return; }
    setStatus('🎹 Cargando soundfont...');
    MIDI.loadPlugin({
      soundfontUrl:  'MIDI.js/examples/soundfont/',
      instrument:    currentInstrument,
      onprogress:    (_state, progress) => {
        setStatus(`🎹 Cargando soundfont… ${Math.round(progress * 100)}%`);
      },
      onsuccess: () => {
        MIDI.setVolume(0, 120);
        midiJsReady = true;
        setStatus('🎹 Piano soundfont listo');
        resolve();
      }
    });
  });
...
// Parsear comando ESP32 y reproducir con MIDI.js soundfont
async function playCommandAsAudio(cmd, bpmVal) {
  if (!midiJsReady) await initMidiAudio();
  ...
  for (const token of tokens) {
    ...
    const c = parts[0], value = parseInt(parts[1]);
    if (c === 'm') { currentMotor = value; currentTime = 0; }
    else if (c === 't') { currentTime += value; }
    else if (c === 'v') {
      const lastVel = lastVelocity[currentMotor] || 0;
      if (lastVel === 0 && value > 0) {
        if (!notesToPlay[currentTime]) notesToPlay[currentTime] = [];
        notesToPlay[currentTime].push({ motor: currentMotor, vel: value });
      }
      lastVelocity[currentMotor] = value;
    }
  }

  // Duración de nota = 1 paso (1/ stepsPerMeasure) en ms
  const stepMs = Math.round(60000 / (bpmVal || bpm) / 4);

  // Cancelar preview anterior
  _previewTimeouts.forEach(clearTimeout);
  _previewTimeouts = [];
  _activeMidiNotes.forEach(n => MIDI.noteOff(0, n, 0));
  _activeMidiNotes.clear();

  let notesPlayed = 0;
  for (const timeStr in notesToPlay) {
    const time = parseInt(timeStr);
    for (const { motor, vel } of notesToPlay[time]) {
      const _key     = DEFAULT_KEYS.find(k => k.motor === motor);
      const _semi    = NOTE_TO_SEMITONE[(_key?.note ?? '').split('/')[0]] ?? (motor % 12);
      const _oct     = _key?.octave ?? 4;
      const midiNote = (_oct + 1) * 12 + _semi;
      const velocity = Math.min(127, Math.round(vel * 127 / 255));
      notesPlayed++;

      const hOn = setTimeout(() => {
        if (!midiJsReady) return;
        MIDI.noteOn(0, midiNote, velocity, 0);
        _activeMidiNotes.add(midiNote);
      }, time);

      const hOff = setTimeout(() => {
        MIDI.noteOff(0, midiNote, 0);
        _activeMidiNotes.delete(midiNote);
      }, time + stepMs);

      _previewTimeouts.push(hOn, hOff);
    }
  }
  console.log(`✅ Notas programadas: ${notesPlayed}`);
}

// ============================================================
// MODELO DE DATOS: steps[i] = 0 (vacío/ocupado) | D>0 (nota de D pasos que empieza aquí)
// Compatible con el modelo antiguo donde steps[i]=1 significa nota de 1/ stepsPerMeasure.
// ============================================================
...
function buildCommand(chs, _bpm, _hitDur, _numSteps) {
  ...
  Object.values(motorGroups).forEach(ch => {
    ...
    for (let i = 0; i < _numSteps; i++) {
      ...
      // Velocidad por paso: usar vels[i] si existe, sino vel del canal
      const stepVel = (ch.vels && ch.vels[i] > 0) ? ch.vels[i] : ch.vel;
      const vHit    = `v ${stepVel};`;
...
let _previewTimeouts   = [];     // setTimeout handles de notas de preview (cancelables)
...
function _buildMeasureCmd(m) {
  ...
  const sliced = channels.map(ch => ({ ...ch, steps: ch.steps.slice(start, start + stepsPerMeasure) }));
  return buildCommand(sliced, bpm, hitDur, stepsPerMeasure);
}
...
function _drumStreamTick() {
  ...
  const measureMs = Math.round(60000 / bpm / 4) * stepsPerMeasure;
...
function deleteMeasure(m) {
  ...
  _pushUndo();
  const start = m * stepsPerMeasure;
  channels.forEach(ch => ch.steps.splice(start, stepsPerMeasure));
  numMeasures--;
  numSteps = numMeasures * stepsPerMeasure;
...
function playMeasure(m) {
  drumStreamStop();
  const start     = m * stepsPerMeasure;
  const slicedChs = channels.map(ch => ({ ...ch, steps: ch.steps.slice(start, start + stepsPerMeasure) }));
  const cmd       = buildCommand(slicedChs, bpm, hitDur, stepsPerMeasure);
...
function renderHeaders() {
  ...
  for (let m = 0; m < numMeasures; m++) {
    ...
    const numSpan = `<span onclick="event.stopPropagation();playMeasure(${m})" title="Reproducir compás ${m+1}" style="cursor:pointer;padding:0 4px;border-radius:3px;" onmouseover="this.style.background='rgba(255,255,255,.08)'" onmouseout="this.style.background=''">C${m + 1}</span>`;
    html += `<th colspan="19" class="measure-label mc${m % 4}${selClass}" onclick="toggleMeasureSel(${m})"><div style="position:relative">${numSpan}${playBtn}${delBtn}</div></th>`;
  }
  html += '</tr>';
  ...
  for (let s = 0; s < numSteps; s++) {
    if (s > 0 && s % stepsPerMeasure === 0)     html += '<td class="measure-gap"></td>';
    else if (s > 0 && s % 4 === 0) html += '<td class="beat-gap"></td>';
    const isBeat     = (s % 4 === 0);
    const measureIdx = Math.floor(s / stepsPerMeasure);
    const beatNum    = (s % stepsPerMeasure) / 4 + 1;
...
function renderChannels() {
  ...
  channels.forEach((ch, ci) => {
    ...
    // Título con nombre del canal + botones de navegación ▲ ▼
    const panelTitle = document.createElement('div');
    panelTitle.className = 'ch-opt-title';
    panelTitle.style.cssText = 'display:flex;align-items:center;justify-content:space-between;gap:4px';

    const navUpBtn = document.createElement('button');
    navUpBtn.textContent = '▲';
    navUpBtn.title = 'Canal anterior';
    navUpBtn.style.cssText = 'background:transparent;border:1px solid #334;color:#aaa;border-radius:3px;cursor:pointer;padding:0 5px;font-size:10px;line-height:1.6;flex-shrink:0';
    navUpBtn.disabled = (ci === 0);
    navUpBtn.onclick = e => {
      e.stopPropagation();
      optPanel.classList.remove('open'); optBtn.classList.remove('open');
      document.querySelector(`.ch-opt-btn[data-ci="${ci - 1}"]`)?.click();
    };

    const titleSpan = document.createElement('span');
    titleSpan.textContent = ch.name;
    titleSpan.style.cssText = 'flex:1;text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap';

    const navDnBtn = document.createElement('button');
    navDnBtn.textContent = '▼';
    navDnBtn.title = 'Canal siguiente';
    navDnBtn.style.cssText = 'background:transparent;border:1px solid #334;color:#aaa;border-radius:3px;cursor:pointer;padding:0 5px;font-size:10px;line-height:1.6;flex-shrink:0';
    navDnBtn.disabled = (ci === channels.length - 1);
    navDnBtn.onclick = e => {
      e.stopPropagation();
      optPanel.classList.remove('open'); optBtn.classList.remove('open');
      document.querySelector(`.ch-opt-btn[data-ci="${ci + 1}"]`)?.click();
    ...
    panelTitle.appendChild(navUpBtn);
    panelTitle.appendChild(titleSpan);
    panelTitle.appendChild(navDnBtn);
    optPanel.appendChild(panelTitle);
    ...
    testBtn.textContent = `🥁 Test ${channels[ci].name}`;
    testBtn.title = `Test hit: ${channels[ci].name} (motor ${channels[ci].motor})`;
    testBtn.onclick = () => {
      ...
      sendCommand(cmd);
      setStatus(`Testing hit: ${channels[ci].name} — motor ${channels[ci].motor} (PCA ${channels[ci].pca})`);
    };
    ...
    optBtn.onclick = e => {
      ...
      if (!alreadyOpen) {
        ...
        requestAnimationFrame(() => testBtn.focus());
      }
    };
    optPanel.addEventListener('click', e => e.stopPropagation());
    optPanel.addEventListener('keydown', e => {
      if (e.key === 'ArrowUp' && ci > 0) {
        e.preventDefault();
        optPanel.classList.remove('open'); optBtn.classList.remove('open');
        document.querySelector(`.ch-opt-btn[data-ci="${ci - 1}"]`)?.click();
      } else if (e.key === 'ArrowDown' && ci < channels.length - 1) {
        e.preventDefault();
        optPanel.classList.remove('open'); optBtn.classList.remove('open');
        document.querySelector(`.ch-opt-btn[data-ci="${ci + 1}"]`)?.click();
      }
    ...
    // Pre-calcular clases de bloque por duración de nota (steps[i] = duración en 1/ stepsPerMeasure)
...
function toggleStep(ci, si) {
  ...
  if (!ch.vels) ch.vels = new Array(steps.length).fill(0);
  ...
  if (ns >= 0) {
    ...
    steps[si]    = 1;
    ch.vels[si]  = ch.vel;  // velocidad por defecto del canal
  }
  renderChannels();
  const cmd = generateCommand();
  if (isPlaying && cmd) sendLive(cmd);
...
function showDurationPicker(e, ci, stepIdx) {
  ...
  const stepMs = Math.round(60000 / bpm / 4);
  const opts = [
    { sym: '♬', label: '1/ stepsPerMeasure', steps: 1  },
  ...
  const insertAt = Math.floor(stepIdx / stepsPerMeasure) * stepsPerMeasure;
  ...
  ib.onclick = () => {
    _pushUndo();
    channels.forEach(ch => ch.steps.splice(insertAt, 0, ...new Array(stepsPerMeasure).fill(0)));
    numMeasures++;
    numSteps = numMeasures * stepsPerMeasure;
    document.getElementById('measuresInput').value = numMeasures;
    picker.remove();
...
function snapAllChannels(targetSteps) {
  ...
  channels.forEach(ch => {
    ...
    if (targetSteps === 1) {
      // Expandir: toda nota de duración > 1 se despliega en 1/ stepsPerMeasure individuales
      for (let i = 0; i < n; i++) {
        if (s[i] > 1) {
      ...
      // Agrupar: dentro de cada compás (stepsPerMeasure pasos), iterar grupos de targetSteps
      // alineados a sus fronteras naturales. Solo fusiona si TODOS los pasos
      // del grupo contienen exactamente una nota de 1 paso (steps[i] === 1).
      for (let mStart = 0; mStart < n; mStart += stepsPerMeasure) {
        for (let g = mStart; g + targetSteps <= mStart + stepsPerMeasure; g += targetSteps) {
          let allOne = true;
  ...
  const durLabel = ['','1/ stepsPerMeasure','1/8','','1/4','','','','1/2','','','','','','','','1'][targetSteps] || targetSteps;
  if (totalMerged > 0)
...
// Convierte cada nota 1/ stepsPerMeasure aislada en 1/8 usando el hueco adyacente libre.
...
function deduplicateMeasures() {
  ...
  for (let m = 0; m < numMeasures; m++) {
    const start = m * stepsPerMeasure;
    const sig = channels.map(ch => ch.steps.slice(start, start + stepsPerMeasure).join(',')).join('|');
  ...
  channels.forEach(ch => {
    ch.steps = keepIdx.flatMap(m => ch.steps.slice(m * stepsPerMeasure, m * stepsPerMeasure + stepsPerMeasure));
  });
...
function convert16to8() {
  ...
  channels.forEach(ch => {
    ...
    for (let i = 0; i < n; i++) {
      if (s[i] !== 1) continue;                        // solo notas 1/ stepsPerMeasure

      const mEnd = Math.floor(i / stepsPerMeasure) * stepsPerMeasure + stepsPerMeasure - 1;
  ...
  if (total > 0)
    setStatus(`1/ stepsPerMeasure→1/8 → ${total} note${total > 1 ? 's' : ''} in ${affectedCh} channel${affectedCh > 1 ? 's' : ''}`);
  else
    setStatus('1/ stepsPerMeasure→1/8 → no eligible notes');
}
...
function startMetronome(startStep = 0) {
  ...
  // Crear un callback cada paso (cada 1/ stepsPerMeasure)
  let stepCallback = Tone.Transport.scheduleRepeat((_time) => {
    ...
    if (isPausing && currentStep % stepsPerMeasure === 15) {
      isPausing = false;
      isPlaying = false;
      Tone.Transport.stop();
  ...
  }, '16n');  // cada 1/ stepsPerMeasure nota
...
function initWS() {
  ...
  ws.onerror = () => {
    wsConnected = false;
    console.info(`[aTambor] WebSocket no disponible en ${url} — modo sin hardware activo`);
  };
  ws.onmessage = e => {
...
function saveAsGrooveScript() {
  ...
  const gridSize = numMeasures * stepsPerMeasure;
  ...
  const durToStr = d => ({ 16:'1', 8:'1/2', 4:'1/4', 2:'1/8', 1:'1/ stepsPerMeasure' }[d] || `${d}/ stepsPerMeasure`);
  ...
  for (const ev of events) {
    ...
    line += (line ? ' ' : '') + token;
    stepCount += ev.dur;
    if (stepCount % stepsPerMeasure === 0) {
      lines.push(line + ' |');
      line = '';
    }
  }
    ...
    reader.onload = ev => {
      try {
        ...
        if (d.channels && d.channels.length) {
          ...
          numMeasures = Math.max(1, Math.round(numSteps / stepsPerMeasure));
          document.getElementById('measuresInput').value = numMeasures;
        }
...
function songEntryMs(e) {
  let totalSteps = e.numMeasures * stepsPerMeasure;
  ...
  if (rawSeq) {
    ...
    if (nums.length > 0) totalSteps = nums.length * stepsPerMeasure;
  }
  ...
  reader.onload = ev => {
    try {
      ...
      songQueue.push({
        ...
        bpm:         d.bpm      || 120,
        hitDur:      d.hitDur   || 80,
        numMeasures: d.numMeasures || Math.max(1, Math.round((d.channels && d.channels[0] && d.channels[0].steps.length / stepsPerMeasure) || 1)),
          measureSeq:  ''
      });
      renderSongQueue();
...
function songSendNext() {
  ...
  let chs = e.channels;
  let ns  = e.numMeasures * stepsPerMeasure;
  const rawSeq = e.measureSeq && e.measureSeq.trim();
  if (rawSeq) {
    const seqNums = expandMeasureSeq(rawSeq, e.numMeasures);
    if (seqNums.length > 0) {
      ns  = seqNums.length * stepsPerMeasure;
      chs = e.channels.map(ch => {
        const newSteps = [];
        seqNums.forEach(m => { const st = (m - 1) * stepsPerMeasure; for (let i = 0; i < stepsPerMeasure; i++) newSteps.push(ch.steps[st + i] || 0); });
...
function buildPreviewCommand(entry) {
  ...
  let ns  = entry.numMeasures * stepsPerMeasure;
...
// Devuelve un array de (numExpandedMeasures * stepsPerMeasure) booleans por canal, indexado por motor.
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Compás (time signature)
  document.getElementById('timeSigSelect').onchange = e => {
    const sig = e.target.value;
    if (!TIME_SIGNATURES[sig]) return;
    currentTimeSig  = sig;
    stepsPerMeasure = TIME_SIGNATURES[sig].stepsPerMeasure;
    // Borrar patrón y reiniciar con el nuevo compás
    channels.forEach(ch => { ch.steps = new Array(numMeasures * stepsPerMeasure).fill(0); });
    numSteps = numMeasures * stepsPerMeasure;
    render();
    setStatus(`Compás: ${sig} (${stepsPerMeasure} pasos/compás)`);
  };
  ...
  _btnPause.onclick = () => {
    ...
    if (drumStreamPauseIdx >= 0) {
      // ---- RESUME ----
      const resumeStep = (drumStreamPauseIdx % numMeasures) * stepsPerMeasure; // primer paso del compás a reanudar
      checkESP32(() => {
        drumStreamResume();
        isPlaying = true;
  ...
  _btnStop.onclick = () => {
    ...
    // Cancelar notas de preview pendientes y detener las activas
    _previewTimeouts.forEach(clearTimeout);
    _previewTimeouts = [];
    if (midiJsReady) {
      _activeMidiNotes.forEach(n => MIDI.noteOff(0, n, 0));
  ...
  // Fusionar grupos de notas 1/ stepsPerMeasure consecutivas en notas de hasta 1/4
  ...
  document.getElementById('btnSnap').onclick = e => {
    ...
    const opts = [
      ...
      { sym: '𝅗𝅥', label: '1/2',  steps: 8  },
      { sym: '𝅝',  label: '1',    steps: 16 },
      { sym: '⇒', label: '1/ stepsPerMeasure→1/8', steps: null, action: () => convert16to8() },
  ...
  document.getElementById('btnSongStop').onclick = () => document.getElementById('btnStop').click();
  ...
  document.getElementById('audioToggle').onchange = async (e) => {
    ...
    if (audioEnabled) {
      await initMidiAudio();
      setStatus('🎹 Piano soundfont ACTIVADO');
    } else {
      if (midiJsReady) {
        _activeMidiNotes.forEach(n => MIDI.noteOff(0, n, 0));
        _activeMidiNotes.clear();
      }
      setStatus('🎹 Piano soundfont desactivado');
    }
  };
...
function midiToRhythm(md, noteMap, htDur) {
  // Ticks por paso según el compás del MIDI
  // Para X/4: un paso = 1/16 = division/4 ticks
  // Para X/8: un paso = 1/8  = division/2 ticks
  const ticksPerStep = md.division * 4 / md.timeSigDen;
  const spm          = md.timeSigNum;  // pasos por compás = numerador del compás
  const tps          = ticksPerStep;
  const nMeas  = Math.max(1, Math.ceil(Math.ceil((md.maxTick + tps) / tps) / spm));
  const nSteps = nMeas * spm;

  const validMotors = new Set(DEFAULT_KEYS.map(k => k.motor));
  const byKey = {};
  md.events.forEach(e => {
    const key   = `${e.ch}_${e.note}`;
    const motor = (noteMap[key] != null) ? parseInt(noteMap[key]) : -1;
    if (motor < 0 || !validMotors.has(motor)) return;
    if (!byKey[key]) byKey[key] = { motor, ch: e.ch, note: e.note, steps: new Array(nSteps).fill(0), vels: new Array(nSteps).fill(0) };
    ...
    // Escribir duración y velocidad del MIDI
    const durSteps = endStep - startStep + 1;
    byKey[key].steps[startStep] = durSteps;
    byKey[key].vels[startStep]  = e.vel;  // velocity original del MIDI (0-127)
    for (let i = startStep + 1; i <= endStep; i++)
      byKey[key].steps[i] = 0;
  });

  const chs = Object.values(byKey).sort((a, b) => a.motor - b.motor).map(k => {
    const velValues = k.vels.filter(v => v > 0);
    const avgVel = velValues.length ? Math.round(velValues.reduce((a, b) => a + b, 0) / velValues.length) : 70;
    return {
  ...
  return { bpm: md.bpm, hitDur: htDur || 80, numMeasures: nMeas, stepsPerMeasure: spm, timeSigNum: md.timeSigNum, timeSigDen: md.timeSigDen, channels: chs };
}
...
function _loadRhythmFromNoteMap(md, noteMap) {
  ...
  // Aplicar el compás detectado en el MIDI
  const midiTimeSig = `${rhythm.timeSigNum}/${rhythm.timeSigDen}`;
  if (TIME_SIGNATURES[midiTimeSig]) {
    currentTimeSig  = midiTimeSig;
    stepsPerMeasure = TIME_SIGNATURES[midiTimeSig].stepsPerMeasure;
  } else {
    // Compás no estándar: usar stepsPerMeasure del ritmo directamente
    stepsPerMeasure = rhythm.stepsPerMeasure;
  }
  const timeSigSel = document.getElementById('timeSigSelect');
  if (timeSigSel) timeSigSel.value = currentTimeSig;

  numMeasures = rhythm.numMeasures;
  numSteps    = rhythm.numMeasures * stepsPerMeasure;
  document.getElementById('measuresInput').value = numMeasures;
  ...
  channels = DEFAULT_KEYS.map(k => ({
    ...
    vels:  new Array(numSteps).fill(0)
  }));
  ...
  rhythm.channels.forEach(midiCh => {
    ...
    for (let i = 0; i < numSteps && i < midiCh.steps.length; i++) {
      if (midiCh.steps[i]) {
        target.steps[i] = midiCh.steps[i];
        target.vels[i]  = midiCh.vels?.[i] || midiCh.vel || 70;
      }
    }
    target.vel     = midiCh.vel;
...
function showMidiModal(md) {
  ...
  btnRow.appendChild(_mkModalBtn('Siguiente →', '#3498db', () => {
    ...
    showMidiAutoTranspose(md, selChs);
  }));
...
// ============================================================
// PASO 2 — (eliminado: iba directo a auto-transpose)
// ============================================================
...
// ============================================================
// PASO 2 — Asignación cromática automática (DEFAULT_KEYS motores)
// ============================================================
function showMidiAutoTranspose(md, selChs) {
  ...
  const REPR = DEFAULT_KEYS.map(key => {
    const semitone = NOTE_TO_SEMITONE[key.note.split('/')[0]] ?? (key.motor % 12);
    const octave   = key.octave ?? 4;
    return (octave + 1) * 12 + semitone;
  });

  // Para cada semitono, índices de REPR que lo contienen (puede haber uno por PCA)
  const semitoneCandidates = {};
  REPR.forEach((midiNote, idx) => {
    const pc = midiNote % 12;
    if (!semitoneCandidates[pc]) semitoneCandidates[pc] = [];
    semitoneCandidates[pc].push(idx);
  });

  // ── Detectar la transposición óptima ─────────────────────────
  // Prueba desplazamientos -24..+24 semitonos y elige el que maximiza
  // coincidencias exactas con REPR. Desempate: menor suma de motores (PCA0 primero).
  const reprSet = new Set(REPR);
  const midiNotesInFile = [...new Set(
    md.events.filter(e => selChs.includes(e.ch)).map(e => e.note)
  )];
  const totalNotes = midiNotesInFile.length;
  let bestShift = 0, bestMatches = -1;
  for (let shift = -24; shift <= 24; shift++) {
    const matches = midiNotesInFile.filter(n => reprSet.has(n + shift)).length;
    // Prioridad: más coincidencias. Empate: shift más cercano a 0.
    if (matches > bestMatches ||
       (matches === bestMatches && Math.abs(shift) < Math.abs(bestShift))) {
      bestMatches = matches;
      bestShift   = shift;
    }
    // Cobertura completa: no hay nada mejor, parar en shift=0 si ya lo encontramos
    if (bestMatches === totalNotes && bestShift === 0) break;
  }

  function buildEvents() {
    return md.events.map(e => {
      if (!selChs.includes(e.ch)) return e;
      const shifted = e.note + bestShift;
      // 1. Coincidencia exacta tras aplicar el desplazamiento detectado
      const exactIdx = REPR.indexOf(shifted);
      if (exactIdx >= 0) return { ...e, note: REPR[exactIdx] };
      // 2. Mismo semitono, candidato más cercano en pitch
      const pc = ((shifted % 12) + 12) % 12;
      const candidates = semitoneCandidates[pc] ?? [pc];
      const bestIdx = candidates.reduce((best, idx) =>
        Math.abs(REPR[idx] - shifted) < Math.abs(REPR[best] - shifted) ? idx : best
      , candidates[0]);
      return { ...e, note: REPR[bestIdx] };
    });
  }
  ...
  const shiftLabel = bestShift === 0 ? 'none' : (bestShift > 0 ? `+${bestShift}` : `${bestShift}`) + ' semitones';
  const matchCount = midiNotesInFile.filter(n => reprSet.has(n + bestShift)).length;
  resDiv.innerHTML =
    `<div style="color:#888">Transposición detectada: <span style="color:#ff8800;font-weight:bold">${shiftLabel}</span> · ${matchCount}/${midiNotesInFile.length} notas con coincidencia exacta</div>` +
    `<div style="color:#2ecc71;margin-top:4px">✔ ${selChs.length} instrument${selChs.length>1?'s':''} · motors 0–${DEFAULT_KEYS[DEFAULT_KEYS.length-1].motor}</div>`;
  ...
  DEFAULT_KEYS.forEach((key, idx) => {
    const tr = document.createElement('tr');
    tr.style.cssText = 'border-top:1px solid #1e1e36';
    tr.innerHTML = `
      <td style="padding:5px 8px;text-align:center;color:#fff">${key.motor}</td>
      <td style="padding:5px 10px;color:#ddd;font-size:13px">${key.name}</td>
      <td style="padding:5px 8px;text-align:center;color:#556;font-size:11px">${REPR[idx]}</td>`;
    tbody.appendChild(tr);
  });
  ...
  btnRow.appendChild(_mkModalBtn('✔ Load to Sequencer', col, () => {
    ...
    const noteMap = {};
    selChs.forEach(ch => REPR.forEach((note, idx) => {
      noteMap[`${ch}_${note}`] = DEFAULT_KEYS[idx].motor;
    }));
...
// Musical: "1"→16, "1/2"→8, "1/4"→4, "1/8"→2, "1/ stepsPerMeasure"→1
...
function mmlrDurationToSteps(durStr, tempo) {
  ...
  if (fracMatch) {
    ...
    return Math.max(1, Math.round((num / den) * stepsPerMeasure));
  }
...
function mmlrToFragment(parsed) {
  ...
  const totalMeasures = Math.max(1, Math.ceil(totalSteps / stepsPerMeasure));
...
function openChordConverterModal() {
  ...
  [
    ...
    ['Groove',      '@TEMPO=120\n@DEFAULT_DUR=1/8\n\n[ C:1/ stepsPerMeasure R:1/ stepsPerMeasure C:1/8 R:1/8 ]x4'],
  ].forEach(([label, tmpl]) => {
    const btn = document.createElement('button');
...
function _buildMeasureNotes(mi, VF) {
  const offset = mi * stepsPerMeasure;
  const byStep = {};
...
function _buildStaffToolbar() {
  ...
  h += `<div style="padding:4px 8px;cursor:pointer;border-radius:3px;font-size:12px;${staffEditMode==='tuplet' && staffTupletCount===3 ? 'background:#7d3c98;color:#fff;' : ''}" onmouseover="this.style.background='#a370bb'" onmouseout="this.style.background='${staffEditMode==='tuplet' && staffTupletCount===3 ? '#7d3c98' : ''}'" onclick="_selectStaffMode('tuplet'); _toggleStaffDropdown('more-menu')">𝅘𝅥‿𝅘𝅥‿𝅘𝅥 Triplet</div>`;
  h += `<div style="padding:4px 8px;cursor:pointer;border-radius:3px;font-size:12px;${staffEditMode==='tuplet' && staffTupletCount===6 ? 'background:#6c3483;color:#fff;' : ''}" onmouseover="this.style.background='#8a5aaa'" onmouseout="this.style.background='${staffEditMode==='tuplet' && staffTupletCount===6 ? '#6c3483' : ''}'" onclick="_selectStaffMode('tuplet6'); _toggleStaffDropdown('more-menu')">𝅘𝅥𝅘𝅥𝅘𝅥 Sextuplet</div>`;
...
function _onStaffSvgClick(ev) {
  ...
  const absStep = mi * stepsPerMeasure + step;
