...
const DEFAULT_KEYS = [
  ...
  { name: 'C1',  note: 'C',      octave: 1, pca: 0, motor: 0  },
  { name: 'C#1', note: 'C#/Db',  octave: 1, pca: 0, motor: 1  },
  { name: 'D1',  note: 'D',      octave: 1, pca: 0, motor: 2  },
  { name: 'D#1', note: 'D#/Eb',  octave: 1, pca: 0, motor: 3  },
  { name: 'E1',  note: 'E',      octave: 1, pca: 0, motor: 4  },
  { name: 'F1',  note: 'F',      octave: 1, pca: 0, motor: 5  },
  { name: 'F#1', note: 'F#/Gb',  octave: 1, pca: 0, motor: 6  },
  { name: 'G1',  note: 'G',      octave: 1, pca: 0, motor: 7  },
  { name: 'G#1', note: 'G#/Ab',  octave: 1, pca: 0, motor: 8  },
  { name: 'A1',  note: 'A',      octave: 1, pca: 0, motor: 9  },
  { name: 'A#1', note: 'A#/Bb',  octave: 1, pca: 0, motor: 10 },
  { name: 'B1',  note: 'B',      octave: 1, pca: 0, motor: 11 },

  // ── PCA 1  (I2C 0x41)  —  C2–B2  (motors 16-27, 28-31 libres) ─
  { name: 'C2',  note: 'C',      octave: 2, pca: 1, motor: 12 },
  { name: 'C#2', note: 'C#/Db',  octave: 2, pca: 1, motor: 13 },
  { name: 'D2',  note: 'D',      octave: 2, pca: 1, motor: 14 },
  { name: 'D#2', note: 'D#/Eb',  octave: 2, pca: 1, motor: 15 },
  { name: 'E2',  note: 'E',      octave: 2, pca: 1, motor: 15 },
  { name: 'F2',  note: 'F',      octave: 2, pca: 1, motor: 41 },
  { name: 'F#2', note: 'F#/Gb',  octave: 2, pca: 1, motor: 42 },
  { name: 'G2',  note: 'G',      octave: 2, pca: 1, motor: 43 },
  { name: 'G#2', note: 'G#/Ab',  octave: 2, pca: 1, motor: 44 },
  { name: 'A2',  note: 'A',      octave: 2, pca: 1, motor: 45 },
  { name: 'A#2', note: 'A#/Bb',  octave: 2, pca: 1, motor: 46 },
  { name: 'B2',  note: 'B',      octave: 2, pca: 1, motor: 47 },*/

  // ── PCA 2  (I2C 0x42)  —  C3–B3  (motors 32-43, 44-47 libres) ─
  { name: 'C3',  note: 'C',      octave: 4, pca: 2, motor: 0 },
  { name: 'C#3', note: 'C#/Db',  octave: 4, pca: 2, motor: 1 },
  { name: 'D3',  note: 'D',      octave: 4, pca: 2, motor: 2 },
  { name: 'D#3', note: 'D#/Eb',  octave: 4, pca: 2, motor: 3 },
  { name: 'E3',  note: 'E',      octave: 4, pca: 2, motor: 4 },
  { name: 'F3',  note: 'F',      octave: 4, pca: 2, motor: 5 },
  { name: 'F#3', note: 'F#/Gb',  octave: 4, pca: 2, motor: 6 },
  { name: 'G3',  note: 'G',      octave: 4, pca: 2, motor: 7 },
  { name: 'G#3', note: 'G#/Ab',  octave: 4, pca: 2, motor: 8 },
  { name: 'A3',  note: 'A',      octave: 4, pca: 2, motor: 9 },
  { name: 'A#3', note: 'A#/Bb',  octave: 4, pca: 2, motor: 10 },
  { name: 'B3',  note: 'B',      octave: 4, pca: 2, motor: 11 },

  // ── PCA 3  (I2C 0x43)  —  C4–B4  (motors 48-59, 60-63 libres) ─
  { name: 'C4',  note: 'C',      octave: 5, pca: 3, motor: 12 },
  { name: 'C#4', note: 'C#/Db',  octave: 5, pca: 3, motor: 13 },
  { name: 'D4',  note: 'D',      octave: 5, pca: 3, motor: 14 },
  { name: 'D#4', note: 'D#/Eb',  octave: 5, pca: 3, motor: 15 },
  /*{ name: 'E4',  note: 'E',      octave: 4, pca: 3, motor: 16 },
  { name: 'F4',  note: 'F',      octave: 4, pca: 3, motor: 17 },
  { name: 'F#4', note: 'F#/Gb',  octave: 4, pca: 3, motor: 18 },
  { name: 'G4',  note: 'G',      octave: 4, pca: 3, motor: 19 },
  { name: 'G#4', note: 'G#/Ab',  octave: 4, pca: 3, motor: 20 },
  { name: 'A4',  note: 'A',      octave: 4, pca: 3, motor: 21 },
  { name: 'A#4', note: 'A#/Bb',  octave: 4, pca: 3, motor: 22 },
  { name: 'B4',  note: 'B',      octave: 4, pca: 3, motor: 23 },
