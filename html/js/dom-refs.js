...
//
// Sustituye a los antiguos `const canvas = ...` globales de
// midiGrid.js y a los guards `typeof statusSpan !== 'undefined'`.
// ============================================================
...
export const statusSpan        = document.getElementById('statusMsg');
